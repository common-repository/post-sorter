...
class PostSorter {
	...
	public function activate() {
		...
		update_option( 'post_sorter_no_admin_sort', FALSE );
	...
	public function join( $sql ) {
		...
		if( get_option( 'post_sorter_no_admin_sort' ) && is_admin() )
			return $sql;
	...
	public function save_settings() {
		...
		update_option( 'post_sorter_no_admin_sort', isset( $_POST['post_sorter_no_admin_sort'] ) );
