			...
			<tbody>
				<tr valign="top">
					...
					<td>
						...
						<span class="hint"><?php _e( 'Enable sorting on the front-end', 'post_sorter' ) ?></span>
					</td>
				</tr>

				<tr valign="top">
					<th scope="row"><label for="post_sorter_no_admin_sort"><?php _e( 'Disable Admin Sorting', 'post_sorter' ) ?></label>:</th>
					<td>
						<input name="post_sorter_no_admin_sort" id="post_sorter_no_admin_sort" type="checkbox" <?php checked( 1, get_option( 'post_sorter_no_admin_sort' ) )?> />
						<span class="hint"><?php _e( 'The plugin will not sort administrative post lists', 'post_sorter' ) ?></span>
					</td>
				</tr>
